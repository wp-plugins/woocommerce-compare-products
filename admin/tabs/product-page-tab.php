...
class WC_Compare_Product_Page_Tab extends WC_Compare_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			'name'				=> 'product-page',
			'label'				=> __( 'Product Page', 'woo_cp' ),
			'callback_function'	=> 'wc_compare_product_page_tab_manager',
		);
...
$wc_compare_product_page_tab = new WC_Compare_Product_Page_Tab();

/** 
 * wc_compare_product_page_tab_manager()
 * Define the callback function to show tab content
 */
function wc_compare_product_page_tab_manager() {
	global $wc_compare_product_page_tab;
	$wc_compare_product_page_tab->tab_manager();
}

...
class WC_Compare_GridView_Style_Tab extends WC_Compare_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			'name'				=> 'product-cards',
			'label'				=> __( 'Product Cards', 'woo_cp' ),
			'callback_function'	=> 'wc_compare_gridview_style_tab_manager',
		);
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/gridview-style/global-settings.php' );
		include_once( $this->admin_plugin_dir() . '/settings/gridview-style/compare-button-settings.php' );
		include_once( $this->admin_plugin_dir() . '/settings/gridview-style/view-compare-settings.php' );
...
$wc_compare_gridview_style_tab = new WC_Compare_GridView_Style_Tab();

/** 
 * wc_compare_gridview_style_tab_manager()
 * Define the callback function to show tab content
 */
function wc_compare_gridview_style_tab_manager() {
	global $wc_compare_gridview_style_tab;
	$wc_compare_gridview_style_tab->tab_manager();
}

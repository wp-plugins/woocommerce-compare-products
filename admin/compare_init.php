...
function woocp_add_menu_item_e_commerce() {
	...
	$comparable_settings_page = add_submenu_page( $woo_page , __( 'Compare Settings', 'woo_cp' ), __( 'Compare', 'woo_cp' ), 'manage_options', 'woo-compare-settings', 'woo_display_comparable_settings' );
}

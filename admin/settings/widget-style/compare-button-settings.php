...
<?php
/*-----------------------------------------------------------------------------------
WC Compare Widget Button Settings
...
class WC_Compare_Widget_Compare_Button_Settings extends WC_Compare_Admin_UI
{
	 ...
	 */
	public $option_name = 'woo_compare_widget_button_style';
	
	/**
	 * @var string
	 * You must change to correct form key that you are working
	 */
	public $form_key = 'woo_compare_widget_button_style';
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Widget Compare Button Settings successfully saved.', 'woo_cp' ),
				'error_message'		=> __( 'Error: Widget Compare Button Settings can not save.', 'woo_cp' ),
				'reset_message'		=> __( 'Widget Compare Button Settings successfully reseted.', 'woo_cp' ),
			);
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			'name'				=> 'compare-button',
			'label'				=> __( 'Compare Button', 'woo_cp' ),
			'callback_function'	=> 'wc_compare_widget_compare_button_settings_form',
		);
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
            	'name' => __( 'Compare Widget Button / Hyperlink ', 'woo_cp' ),
                'type' => 'heading',
           	),
			array(  
			...
			array(  
				'name' 		=> __( 'Compare Widget Button/Hyperlink Position', 'woo_cp' ),
			...
			array(
            	'name' 		=> __( 'Compare Widget Hyperlink Styling', 'woo_cp' ),
                'type' 		=> 'heading',
			...
			array(
            	'name' 		=> __( 'Compare Widget Button Styling', 'woo_cp' ),
                'type' 		=> 'heading',
...
global $wc_compare_widget_compare_button_settings;
$wc_compare_widget_compare_button_settings = new WC_Compare_Widget_Compare_Button_Settings();

/** 
 * wc_compare_widget_compare_button_settings_form()
 * Define the callback function to show subtab content
 */
function wc_compare_widget_compare_button_settings_form() {
	global $wc_compare_widget_compare_button_settings;
	$wc_compare_widget_compare_button_settings->settings_form();
}

...
<?php
/*-----------------------------------------------------------------------------------
WC Product Page Compare Button Settings
...
class WC_Compare_Product_Page_Compare_Button_Settings extends WC_Compare_Admin_UI
{
	 ...
	 */
	public $option_name = 'woo_compare_product_page_button_style';
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Product Page Compare Button Settings successfully saved.', 'woo_cp' ),
				'error_message'		=> __( 'Error: Product Page Compare Button Settings can not save.', 'woo_cp' ),
				'reset_message'		=> __( 'Product Page Compare Button Settings successfully reseted.', 'woo_cp' ),
			);
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			'name'				=> 'compare-button',
			'label'				=> __( 'Product Page Compare Button', 'woo_cp' ),
			'callback_function'	=> 'wc_compare_product_page_compare_button_settings_form',
		);
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
            	'name' => __( 'Product Page Compare Button / Hyperlink ', 'woo_cp' ),
                'type' => 'heading',
           	),
			array(  
			...
			array(
            	'name' 		=> __( 'Product Page Compare Hyperlink Styling', 'woo_cp' ),
                'type' 		=> 'heading',
			...
			array(
            	'name' 		=> __( 'Product Page Compare Button Styling', 'woo_cp' ),
                'type' 		=> 'heading',
...
/** 
 * wc_compare_product_page_compare_button_settings_form()
 * Define the callback function to show subtab content
 */
function wc_compare_product_page_compare_button_settings_form() {
	global $wc_compare_product_page_compare_button_settings;
	$wc_compare_product_page_compare_button_settings->settings_form();
}

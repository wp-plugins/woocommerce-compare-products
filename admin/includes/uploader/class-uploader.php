...
class WC_Compare_Uploader extends WC_Compare_Admin_UI
{
	 ...
	 * @var string
	 */
	private $custom_post_type_image = 'woo_compare_images';
	
	/**
	 * @var string
	 */
	private $custom_post_type_name = 'Woo Compare Internal Container';
	...
	public function upload_input ( $name_attribute, $id_attribute = '', $value = '', $default_value = '', $field_name = '', $class = '', $css = '', $description = '', $post_id = 0 ) {
		...
		$output .= '<input id="upload_'.$id_attribute.'" class="a3rev-ui-upload-button a3_upload_button button" type="button" value="'.__( 'Upload', 'woo_cp' ).'" rel="'.$post_id.'" /> '.$description;
